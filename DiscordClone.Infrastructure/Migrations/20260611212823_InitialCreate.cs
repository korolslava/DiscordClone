        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    About = table.Column<string>(type: "character varying(190)", maxLength: 190, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DirectMessageParticipants", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DirectMessageParticipants_DirectMessages_DirectMessageId",
                        column: x => x.DirectMessageId,
                        principalTable: "DirectMessages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DirectMessageParticipants_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Messages_DirectMessages_DirectMessageId",
                        column: x => x.DirectMessageId,
                        principalTable: "DirectMessages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServerMemberServerRole", x => new { x.MembersId, x.RolesId });
                    table.ForeignKey(
                        name: "FK_ServerMemberServerRole_ServerMembers_MembersId",
                        column: x => x.MembersId,
                        principalTable: "ServerMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServerMemberServerRole_ServerRoles_RolesId",
                        column: x => x.RolesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DirectMessageParticipants_DirectMessageId",
                table: "DirectMessageParticipants",
                column: "DirectMessageId");

            migrationBuilder.CreateIndex(
                name: "IX_DirectMessageParticipants_UserId",
                table: "DirectMessageParticipants",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_DirectMessageId_CreatedAt",
                table: "Messages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServerMemberServerRole_RolesId",
                table: "ServerMemberServerRole",
                column: "RolesId");
